...
import org.eclipse.leshan.core.link.lwm2m.attributes.*;
 ...
 */
public class SpecificObjectVersionAttributeModel extends LwM2mAttributeModel<Version> {

    public SpecificObjectVersionAttributeModel() {
        super(//
                "ver", //
                Attachment.OBJECT, //
                EnumSet.of(AssignationLevel.OBJECT, AssignationLevel.OBJECT_INSTANCE), // Object_Instance  not in accordance with the LwM2M specifications !!
                AccessMode.R, //
