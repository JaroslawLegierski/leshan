 ...
 */
public class CustomSenMLJsonJacksonEncoderDecoder implements SenMLDecoder, SenMLEncoder {
    private final CustomSenMLJsonRecordSerDes serDes;
    private static final ObjectMapper mapper = new ObjectMapper();

    public CustomSenMLJsonJacksonEncoderDecoder() {
        this(false);
    }
     ...
     */
    public CustomSenMLJsonJacksonEncoderDecoder(boolean allowNoValue) {
        this.serDes = new CustomSenMLJsonRecordSerDes(allowNoValue);
    }
