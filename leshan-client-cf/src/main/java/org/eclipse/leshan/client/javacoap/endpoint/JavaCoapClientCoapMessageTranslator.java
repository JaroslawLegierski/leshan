...
import org.eclipse.leshan.client.javacoap.ObserveCompositeRelationFilter;
import org.eclipse.leshan.client.javacoap.bootstrap.BootstrapResource;
import org.eclipse.leshan.client.javacoap.object.ObjectResource;
import org.eclipse.leshan.client.javacoap.request.JavaCoapLwM2mResponseBuilder;
import org.eclipse.leshan.client.javacoap.request.JavaCoapRequestBuilder;
...
public class JavaCoapClientCoapMessageTranslator {
    ...
    public CoapRequest createCoapRequest(ServerIdentity serverIdentity,
        ...
        JavaCoapRequestBuilder builder = new JavaCoapRequestBuilder(serverIdentity.getIdentity(), toolbox.getEncoder(),
                model, toolbox.getLinkSerializer(), identityHandler);
