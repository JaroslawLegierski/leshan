 ...
 *******************************************************************************/
package org.eclipse.leshan.client.javacoap.endpoint.coap;
...
import org.eclipse.leshan.client.javacoap.endpoint.ClientProtocolProvider;
...
public class CoapClientProtocolProvider implements ClientProtocolProvider {
    ...
    public CaliforniumClientEndpointFactory createDefaultEndpointFactory() {
        return new CoapClientEndpointFactory();
    }
}
