...
import org.eclipse.leshan.client.javacoap.endpoint.stdio.OpensslProcessTransport;

import com.mbed.coap.packet.Opaque;
import com.mbed.coap.transport.CoapTransport;
import com.mbed.coap.transport.javassl.CoapSerializer;

import static org.eclipse.leshan.client.javacoap.endpoint.CoapSchemes.findKeyAlias;
import static org.eclipse.leshan.client.javacoap.endpoint.CoapSchemes.secret;
...
public class OpensslProvider extends TransportProvider {
    ...
    public CoapTransport createUDP(CoapSerializer coapSerializer, InetSocketAddress destAdr, KeyStore ks,
            Pair<String, Opaque> psk) throws GeneralSecurityException, IOException {
        if (psk == null) {
    ...
    private CoapTransport create(CoapSerializer coapSerializer, InetSocketAddress destAdr, Pair<String, Opaque> psk,
            Boolean isDtls) throws GeneralSecurityException, IOException {
    ...
    private CoapTransport create(CoapSerializer coapSerializer, InetSocketAddress destAdr, KeyStore ks, Boolean isDtls)
            throws GeneralSecurityException, IOException {
    ...
    private static File keyPairToTempFile(String alias, KeyStore ks)
            throws KeyStoreException, IOException, CertificateEncodingException, NoSuchAlgorithmException,
