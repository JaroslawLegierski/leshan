...
public class TimestampedLwM2mNodes {
    ...
    private final Map<Double, Map<LwM2mPath, LwM2mNode>> timestampedPathNodesMap;

    private TimestampedLwM2mNodes(Map<Double, Map<LwM2mPath, LwM2mNode>> timestampedPathNodesMap) {
     ...
     */
    public Map<LwM2mPath, LwM2mNode> getNodesAt(Double timestamp) {
    ...
    public Map<LwM2mPath, LwM2mNode> getNodes() {
        ...
        for (Map.Entry<Double, Map<LwM2mPath, LwM2mNode>> entry : timestampedPathNodesMap.entrySet()) {
     ...
     * recent one.
     */
    public Set<Double> getTimestamps() {
    ...
    public static class Builder {
        ...
        private static class InternalNode {
            ...
            public InternalNode(Double timestamp, LwM2mPath path, LwM2mNode node) {
        ...
        public Builder addNodes(double timestamp, Map<LwM2mPath, LwM2mNode> pathNodesMap) {
            for (Entry<LwM2mPath, LwM2mNode> node : pathNodesMap.entrySet()) {
        ...
        public Builder put(Double timestamp, LwM2mPath path, LwM2mNode node) {
        ...
        public Builder add(TimestampedLwM2mNodes timestampedNodes) {
            for (Double timestamp : timestampedNodes.getTimestamps()) {
        ...
        public TimestampedLwM2mNodes build() throws IllegalArgumentException {
            Map<Double, Map<LwM2mPath, LwM2mNode>> timestampToPathToNode = new TreeMap<>(getTimestampComparator());
        ...
        private static Comparator<Double> getTimestampComparator() {
            return (o1, o2) -> {
                if (o1 == null) {
                    return (o2 == null) ? 0 : 1;
                } else if (o2 == null) {
