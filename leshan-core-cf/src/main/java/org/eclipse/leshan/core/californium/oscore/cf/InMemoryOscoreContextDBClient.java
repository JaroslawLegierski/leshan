...
public class InMemoryOscoreContextDBClient extends HashMapCtxDB {
    ...
    private static OSCoreCtx createContex(OscoreParameters oscoreParameters) {
        ...
        try {
            osCoreCtx = new OSCoreCtx(oscoreParameters.getMasterSecret(), true, oscoreParameters.getAeadAlgorithm(),
                    ...
                    oscoreParameters.getHmacAlgorithm(), 32, oscoreParameters.getMasterSalt(), null, 4096);
        } catch (OSException e) {
    ...
    private static OSCoreCtx deriveContext(OscoreParameters oscoreParameters) {
        OSCoreCtx osCoreCtx = null;
        osCoreCtx = createContex(oscoreParameters);
        if (osCoreCtx != null) {
