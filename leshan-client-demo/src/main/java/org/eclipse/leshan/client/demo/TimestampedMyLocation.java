...
public class TimestampedMyLocation extends BaseInstanceEnabler {
    ...
    public TimestampedMyLocation() {
        this(null, null, 1.0f);
    }

    public TimestampedMyLocation(Float latitude, Float longitude, float scaleFactor) {
        if (latitude != null) {
